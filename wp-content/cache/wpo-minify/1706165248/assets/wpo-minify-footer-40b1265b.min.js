...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://levantere.com/wp-content/plugins/elementor/assets/js/frontend.min.js\n- Error message: "+ e.message);}
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://levantere.com/wp-content/plugins/elementor-pro/assets/js/elements-handlers.min.js\n- Error message: "+ e.message);}
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://levantere.com/wp-content/plugins/elementskit-lite/widgets/init/assets/js/animate-circle.min.js\n- Error message: "+ e.message);}
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://levantere.com/wp-content/plugins/elementskit-lite/widgets/init/assets/js/elementor.js\n- Error message: "+ e.message);}
...
catch(e){console.error("WP-Optimize Minify: An error has occurred in the minified code. \n\n- Original script: https://levantere.com/wp-content/plugins/elementor-pro/assets/lib/sticky/jquery.sticky.min.js\n- Error message: "+ e.message);}
