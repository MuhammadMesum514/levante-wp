            ...
            <div id="rtcl-gallery-upload-ui-wrapper"
                ...
                <div class="description alert alert-danger">
                    ...
                    printf(
                        ...
                        esc_html(implode(', ', (array)Functions::get_option_item('rtcl_misc_settings', 'image_allowed_type', array('png', 'jpeg', 'jpg'))))
                    );
                    printf(
        ...
        <script type="text/html" id="tmpl-wprtcl-uploaded-file">
            ...
            <div class="rtcl-gallery-upload-actions">
                <?php if (Functions::user_can_edit_image()) : ?>
                    <a href="#" class="rtcl-button-edit <?php echo esc_attr($button) ?> rtcl-button-icon rtcl-icon-pencil"
                       title="<?php esc_html_e("Edit File", 'classified-listing') ?>"></a>
                <?php endif; ?>
                <a href="#" class="rtcl-button-remove <?php echo esc_attr($button) ?> rtcl-button-icon rtcl-icon-trash"
        ...
        <script type="text/html" id="tmpl-wprtcl-browser-attachment-view">
            ...
            <div class="wprtcl-attachment-info">
                ...
                <div class="details">
                    ...
                    <div class="formatted-length"><strong><?php esc_html_e("Length:", 'classified-listing') ?></strong> {{
            ...
            <script type="text/html" id="tmpl-wprtcl-browser-attachment-image">
                ...
                <div class="wprtcl-attachment-info">
                    ...
                    <form action="" method="post" class="rtcl-form rtcl-form-aligned">
                        <fieldset>
                            <div class="rtcl-control-group">
                                <label for="rtcl_featured"><?php esc_html_e("Image Manipulation", 'classified-listing') ?></label>
                                <a href="#" class="rtcl-image-action-crop <?php echo esc_attr($button) ?> rtcl-button-small"
                                   title="<?php esc_html_e("Crop", 'classified-listing') ?>"><span
                                            class="rtcl-icon-crop"></span></a>
                                <a href="#" class="rtcl-image-action-rotate-cw <?php echo esc_attr($button) ?> rtcl-button-small"
                                   title="<?php esc_html_e("Rotate 90 degrees", 'classified-listing') ?>"><span
                                            class="rtcl-icon-cw"></span></a>
                                <a href="#" class="rtcl-image-action-rotate-ccw <?php echo esc_attr($button) ?> rtcl-button-small"
                                   title="<?php esc_html_e("Rotate -90 degrees", 'classified-listing') ?>"><span
                                            class="rtcl-icon-ccw"></span></a>
                                <a href="#" class="rtcl-image-action-flip-h <?php echo esc_attr($button) ?> rtcl-button-small"
                                   title="<?php esc_html_e("Flip Vertically", 'classified-listing') ?>"><span
                                            class="rtcl-icon-resize-vertical"></span></a>
                                <a href="#" class="rtcl-image-action-flip-v <?php echo esc_attr($button) ?> rtcl-button-small"
                                   title="<?php esc_html_e("Flip Horizontally", 'classified-listing') ?>"><span
                                            class="rtcl-icon-resize-horizontal"></span></a>
                                <a href="#" class="rtcl-image-action-undo <?php echo esc_attr($button) ?> rtcl-button-small"
                            ...
                            <div class="rtcl-control-group">
                                <label for="rtcl_caption"><?php esc_html_e("Image Size", 'classified-listing') ?></label>
                            ...
                            <div class="rtcl-control-group">
                                ...
                                <a href="#" class="rtcl-image-action-save <?php echo esc_attr($button) ?> rtcl-button-small"
                                   title="<?php esc_html_e("Save Image", 'classified-listing') ?>"><?php esc_html_e("Save", 'classified-listing') ?></a>
                                <a href="#" class="rtcl-image-action-cancel <?php echo esc_attr($button) ?> rtcl-button-small"
                                   title="<?php esc_html_e("Cancel", "classified-listing") ?>"><?php esc_html_e("Cancel", 'classified-listing') ?></a>
                                &nbsp;
                                <a href="#" class="rtcl-image-action-restore <?php echo esc_attr($button) ?> rtcl-button-small"
                                ...
                                <div class="wprtcl-image-apply-to">
                                    ...
                                    <label for="wprtcl-image-action-apply-to"><?php esc_html_e("Apply changes to all image sizes", 'classified-listing') ?></label>
                                </div>
                                <# } else { #>
                    ...
                    <div class="details">
                        ...
                        <div class="filename"><strong><?php esc_html_e("Original size:", 'classified-listing') ?></strong> <span
                                    class="rtcl-image-prop-original-size">-</span></div>
                        <div class="filename"><strong><?php esc_html_e("Current size:", 'classified-listing') ?></strong> <span
                                    class="rtcl-image-prop-current-size">-</span></div>
                        <# if(data.recommended !== null ) { #>
                        <div class="filename"><strong><?php esc_html_e("Recommended size:", 'classified-listing') ?></strong>
                            <span
                                    class="rtcl-image-prop-recommended-size"> {{ data.recommended.width }} x {{ data.recommended.height }}</span>
                        </div>
                        <# } #>
                        <div class="filename"><strong><?php esc_html_e("Zoom:", 'classified-listing') ?></strong> <span
            ...
            <div class="wprtcl-overlay">
                ...
                <div class="wprtcl-file-error">
                    ...
                    <span>
                        ...
                        <a href="#" class="<?php echo esc_attr($button) ?>"><?php esc_html_e("Close", 'classified-listing') ?></a>
                    </div>
                </div>
                <# if(data.overlay === true) { #>
            </div>
