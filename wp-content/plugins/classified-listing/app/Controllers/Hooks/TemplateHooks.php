...
class TemplateHooks {
			...
			<div class='list-group-item'>
				<div class='media'>
					...
					<div class='media-body'><span><?php esc_html_e( "Location", "classified-listing" ) ?></span>
						<div class='locations'><?php echo implode( '<span class="rtcl-delimiter">,</span> ', $location ) // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></div>
					</div>
				</div>
			</div>
			<?php
	...
	public static function loop_item_listing_title() {
		...
		echo '<h3 class="' . esc_attr( apply_filters( 'rtcl_listing_loop_title_classes', 'listing-title rtcl-listing-title' ) ) . '"><a href="' . esc_url( $listing->get_the_permalink() ) . '">' .
			// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
