		...
		<table border="0" cellspacing="0" cellpadding="7" style="border:1px solid #CCC;">
			<tr style="background-color:#F0F0F0;">
				<th colspan="2"><?php
					...
					echo get_the_title( $this->get_listing_id() ); ?> (<span class="listing-id"><?php esc_html_e( "ID#", 'classified-listing' ); echo absint( $this->get_listing_id() ) ?></span>)
				</th>
			</tr>
			<tr>
				<td style="border-right:1px solid #CCC; border-bottom:1px solid #CCC; text-align:right;"><?php esc_html_e( 'Pricing ', 'classified-listing' ); ?></td>
				<td><?php
					// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
					echo $this->pricing->getTitle(); ?></td>
			</tr>
			<tr>
				<td style="border-right:1px solid #CCC; border-bottom:1px solid #CCC; text-align:right;"><?php esc_html_e( 'Visible ', 'classified-listing' ); ?></td>
				<td><?php
					/* translators: Days number */
					printf( '<span>%s</span>', sprintf( esc_html(_n( '%s Day', '%s Days', absint( $this->pricing->getVisible() ), 'classified-listing' )), esc_html(number_format_i18n( absint( absint( $this->pricing->getVisible() ) ) )) ) );
			...
			<tr>
				<td style="border-right:1px solid #CCC; border-bottom:1px solid #CCC; text-align:right;"><?php esc_html_e( 'Amount ', 'classified-listing' ); ?></td>
				<td><?php
					// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
