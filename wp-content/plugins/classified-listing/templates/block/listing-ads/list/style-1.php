						...
						<div class="item-content">
							...
							<?php if ( $instance['content_visibility']['content'] && ! empty( $the_loop['excerpt'] ) ) : ?>
								<?php if ( $instance['content_limit'] && ! empty( $the_loop['excerpt'] ) ) { ?>
									<p class="rtcl-excerpt"><?php echo esc_html( wp_trim_words( wpautop( $the_loop['excerpt'] ), $instance['content_limit'], '' ) ); ?></p>
								<?php } ?>
							<?php endif; ?>
							...
							<ul class="rtcl-listing-meta-data">
								...
								<?php if ( $instance['content_visibility']['view'] && ! empty( $the_loop['views'] ) ) : ?>
									<li class="rt-view"><i
											class="rtcl-icon rtcl-icon-eye"></i><?php echo esc_html( $the_loop['views'] ); ?> <?php echo esc_html__( " views", "classified-listing" ); ?>
									</li>
								<?php endif; ?>
							</ul>
