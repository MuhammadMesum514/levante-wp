					...
					<ul>
						<li class="spf_flag_setting field_setting">
							...
							<select name="spf_country_flag_value" id="spf_country_flag_value" onChange="SetFieldProperty('countryFlagGField', this.value);">
								...
								<option value="flagcode">Flag without dial code</option>
							</select>
							<p style="border: 1px solid #ffbe03; padding: 8px 12px; border-radius: 3px; font-size: 12px;"><?php _e("Choose <strong>Flag without dial code</strong> for getting country/dial code in notification/entries.", "gravityforms"); ?></p>
						</li>
