...
class Scripts {
	...
	public function enqueue_admin_scripts() {
		...
		wp_enqueue_script( 'homlisti-admin', Helper::get_js( 'admin' ), [ 'jquery' ], $this->version, true );

		$nonce = wp_create_nonce( "dismissnotice" );
		wp_localize_script( 'homlisti-admin', 'HomlistiAdminObj', [
	...
	private function template_style() {
		...
		if ( RDTheme::$padding_top_footer != '' ) {
			$style .= 'body .main-footer {padding-top:' . RDTheme::$padding_top_footer . '!important;}';
		}
		if ( RDTheme::$padding_bottom_footer != '' ) {
			$style .= 'body .main-footer {padding-bottom:' . RDTheme::$padding_bottom_footer . ';!important}';
		}
